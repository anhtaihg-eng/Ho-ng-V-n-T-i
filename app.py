...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Văn Tài - Trường Tiểu học Đông An - ĐT: 097 2191 114</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Văn Tài - Trường Tiểu học Đông An - ĐT: 097 2191 114</div>", unsafe_allow_html=True)
